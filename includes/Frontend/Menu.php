...
class Menu
{
    public function __construct()
    {
        ...
        // filter hook
        add_filter('wcfm_query_vars', [$this, 'wcfmcsm_query_vars'], 50);
        add_filter('wcfm_endpoint_title', [$this, 'wcfmcsm_endpoint_title'], 50, 2);
        add_filter('wcfm_endpoints_slug', [$this, 'wcfm_custom_menus_endpoints_slug']);
        add_filter('wcfm_menus', [$this, 'wcfmcsm_wcfm_menus'], 20);

        // action hook
        add_action('init', [$this, 'wcfmcsm_init'], 50);
        add_action('wcfm_load_views', [$this, 'wcfm_csm_load_views'], 50);
        add_action('before_wcfm_load_views', [$this, 'wcfm_csm_load_views'], 50);
        add_action('wcfm_load_scripts', [$this, 'wcfm_csm_load_scripts']);
        add_action('after_wcfm_load_scripts', [$this, 'wcfm_csm_load_scripts']);
        add_action('wcfm_load_styles', [$this, 'wcfm_csm_load_styles']);
        add_action('after_wcfm_load_styles', [$this, 'wcfm_csm_load_styles']);
        //add_action('after_wcfm_ajax_controller', [$this, 'wcfm_csm_ajax_controller']);
 ...
 */
    ...
    public function wcfm_csm_load_scripts($end_point)
    {
        global $WCFM;
        switch ($end_point) {
            case 'wcfm-meetings':
    ...
    public function wcfm_csm_load_styles($end_point)
    {
        global $WCFM, $WCFMu;
        switch ($end_point) {
            case 'wcfm-meetings':
